...
File.prototype.getMimeForId = function(file_id, callback) {
    return this.getMimeForPath(this.getPathById(file_id),callback);
};

File.prototype.getMimeForPath = function(filePath, callback) {
...
File.prototype.getSha1sum = function(filePath, callback) {
...
File.prototype.add = function(filePath, callback) {
    var file = this;
    ...
    flow.exec(function() {
        ...
        this.data.id = this.sha1sum +'.'+ extension;
